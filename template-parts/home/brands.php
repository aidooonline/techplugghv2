...
<section class="wrap py-16 sm:py-20">
	...
	<div class="flex gap-3 sm:gap-4 overflow-x-auto pb-2 -mx-5 px-5 sm:mx-0 sm:px-0 sm:overflow-visible [scrollbar-width:none] [-ms-overflow-style:none]">
		<?php foreach ( $cats as $cat ) :
			...
			<a href="<?php echo esc_url( get_term_link( $cat ) ); ?>" class="card-glow group shrink-0 w-36 sm:w-auto sm:flex-1 p-6 flex flex-col items-center text-center hover:-translate-y-1 hover:border-aur-blue/50 hover:shadow-glow transition">
				<span class="w-24 h-24 sm:w-28 sm:h-28 rounded-2xl overflow-hidden bg-gradient-to-br from-aur-elevated to-aur-base flex items-center justify-center mb-3">
