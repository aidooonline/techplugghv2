#!/usr/bin/env python3
"""
Create the mr_boadi products on techpluggh.com via the WooCommerce REST API.
...
def call(e, method, path, params=None, body=None):
    ...
    try:
        ...
        raise SystemExit(f"Network error: {ex}. Is techpluggh.com allowlisted and reachable?")
